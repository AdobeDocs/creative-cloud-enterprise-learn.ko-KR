---
title: ​3. 첫 그래프 만들기
description: 첫 번째 Firefly 그래프 워크플로우를 구축하기 위한 단계별 연습
...
1. 이미지를 노드로 드래그하여 놓습니다.
   ![이미지가 있는 노드](../assets/node-image.png)
...
1. **입력 이미지** 노드 출력을 **마스크 적용** 이미지 노드 입력에 연결합니다.
1. **그레이디언트 마스크** 출력을 **마스크 적용** 마스크/채널 입력에 연결합니다.
   ![플러그 인 노드](../assets/plug-in.png)
