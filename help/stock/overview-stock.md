...
<tr>
  ...
  <td>
      <a href="handdrawn.md">
         <img alt="Adobe에 손으로 그린 아트웍 추가 [!DNL Stock] 이미지" src="assets/handdrawn.jpg" />
      </a>
      <div>
...
<tr>
   ...
   <td>
      <a href="productconfigurator.md">
         <img alt="Adobe을 사용하여 인터랙티브한 상품 구성 앱 만들기 [!DNL Stock]" src="assets/productconfigurator.jpg" />
      </a>
      <div>
...
<tr>
   ...
   <a href="customizecolors.md">
      <img alt="Adobe의 색상 사용자 정의 [!DNL Stock] 벡터 일러스트레이션" src="assets/customizecolors.jpg" />
   </a>
    <div>
...
<tr>
   ...
   <a href="assets/CreateacompositewithPhotoshopontheiPadandAdobeStockimages.pdf">
    ...
    <div>
   <a href="assets/CreateacompositewithPhotoshopontheiPadandAdobeStockimages.pdf"><strong>iPad 및 Adobe에서 Photoshop을 사용하여 합성 이미지 만들기 [!DNL Stock] 이미지(PDF)</strong></a>
    </div>
   ...
   <a href="assets/CreateaUniqueEditorialGraphicwithAfterEffectsandAdobeStock.pdf">
      <img alt="Adobe 애니메이션 만들기 [!DNL Stock] Photoshop의 벡터 일러스트레이션" src="assets/CreateaUniqueEditorialGraphicwithAfterEffectsandAdobeStock.jpg" />
   </a>
    <div>
   <a href="assets/CreateaUniqueEditorialGraphicwithAfterEffectsandAdobeStock.pdf"><strong>Adobe 애니메이션 만들기 [!DNL Stock] Photoshop의 벡터 일러스트레이션(PDF)</strong></a>
    </div>
   ...
   <td>
      ...
      <div>
      <a href="assets/CreateUniqueGraphicsbyCombiningAdobeStockImages.pdf"><strong>Adobe을 결합하여 독특한 그래픽 만들기 [!DNL Stock] 이미지(PDF)</strong></a>
      </div>
...
<tr>
   <td>
      ...
      <div>
      <a href="assets/CreatingaHalloweenCinemagraphwithPhotoshopCCandAdobeStock.pdf"><strong>Photoshop CC 및 Adobe을 사용하여 할로윈 시네마그래프 만들기 [!DNL Stock] (PDF)</strong></a>
      </div>
   ...
   <td>
      ...
      <div>
      <a href="assets/PutyourDatainMotionwithAdobeStockandPremierePro.pdf"><strong>Adobe을 통해 데이터 생동감 발휘 [!DNL Stock] 및 Premiere Pro(PDF)</strong></a>
      </div>
   ...
   <td>
      ...
      <div>
      <a href="assets/RecolorAdobeStockVectorArtworkwithAdobeIllustratortoGetExactlytheLookYouWant.pdf"><strong>Adobe 색상 변경 [!DNL Stock] Adobe Illustrator을 사용한 벡터 아트웍으로 원하는 룩 완성(PDF)</strong></a>
      </div>
 ...
 <tr>
   <td>
      ...
      <div>
      <a href="assets/ShowOffyourDesignWorkintheRealWorldwithAdobeStockandPhotoshop.pdf"><strong>Adobe을 사용하여 실제 환경에서 디자인 작업 공개 [!DNL Stock] 및 Photoshop(PDF)</strong></a>
      </div>
   ...
   <td>
      ...
      <div>
      <a href="assets/UncoveramazingdetailsinAdobeStockimageswithLightroomformobile.pdf"><strong>Adobe에서 디테일 살리기 [!DNL Stock] Lightroom for mobile이 있는 이미지(PDF)</strong></a>
      </div>
   ...
   <td>
      ...
      <div>
      <a href="assets/VisualizePosterDesignsintheRealWorldwithAdobeStockandPhotoshop.pdf"><strong>Adobe을 통해 실제 환경에서 포스터 디자인 시각화 [!DNL Stock] 및 Photoshop(PDF)</strong></a>
      </div>
